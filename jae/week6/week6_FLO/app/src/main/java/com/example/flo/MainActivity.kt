...
//            intent.putExtra("singer", song.singer)
            ...
            if (binding.mainMiniplayerTitleTv.text.toString().equals("라일락")) {
                intent.putExtra("coverImg", R.drawable.img_album_cover_5)
            }
            if (binding.mainMiniplayerTitleTv.text.toString().equals("이 지금")) {
                intent.putExtra("coverImg", R.drawable.img_album_cover_4)
            }
            if (binding.mainMiniplayerTitleTv.text.toString().equals("을의 연애 (WITH 박주원)")) {
                intent.putExtra("coverImg", R.drawable.img_album_cover_3)
            }
            if (binding.mainMiniplayerTitleTv.text.toString().equals("비밀")) {
                intent.putExtra("coverImg", R.drawable.img_album_cover_2)
            }
            if (binding.mainMiniplayerTitleTv.text.toString().equals("바라보기")) {
